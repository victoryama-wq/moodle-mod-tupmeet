 ...
 */
class recording_visibility_changed extends \core\event\base {
    /**
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'tupmeet_recordings';
    }
    ...
    public static function get_name() {
        return get_string('eventrecordingvisibilitychanged', 'tupmeet');
    }
    ...
    public static function get_objectid_mapping() {
        return ['db' => 'tupmeet_recordings', 'restore' => self::NOT_MAPPED];
    }
