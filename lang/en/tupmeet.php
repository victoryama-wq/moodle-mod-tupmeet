...
$string['modulename_help'] = 'TUP Meet lets you schedule synchronous classes using Google Meet from Moodle. It manages session schedules, recurrence, the teacher co-host and publication of class recordings according to institutional configuration.';
$string['modulename_summary'] = 'Schedule Google Meet classes and manage their recordings from Moodle.';
