...
$string['publicationmode'] = 'Future recording publication (preference)';
...
$string['artifactnotice'] = 'TUP Meet applies automatic recording and transcription settings to the meeting space, subject to Workspace licenses and policies. Google starts generating artifacts when someone with the required privileges joins, not at the scheduled time alone. This does not confirm that a recording or transcript exists. Recording publication remains a future preference. Moodle now registers recording links for teachers and managers, but does not publish to students, download MP4 files or retrieve transcripts.';
...
$string['recordingsstateSTARTED'] = 'Recording in progress';
$string['recordingsstateENDED'] = 'Processing';
